...
class ThreadsWithExtendsThreadMethod extends Thread {// Method 1 : using "Thread extends"
	@Override
	public void run() {
	...
	public static void main(String[] args) {
		...
		ThreadsWithExtendsThreadMethod task1 = new ThreadsWithExtendsThreadMethod();
		task1.start();
