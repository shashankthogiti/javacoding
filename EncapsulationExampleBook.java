...
public class EncapsulationExampleBook {
	...
	public static void main(String[] args) {
		...
		EncapsulationExampleBook name = new EncapsulationExampleBook();
		EncapsulationExampleBook price = new EncapsulationExampleBook();
		name.setName("Java");
		price.setPrice("200/-");
